...
def data_maxwell():
    raw_data = loadarff("../data_experiment/classic/maxwell.arff")
    df_data = pd.DataFrame(raw_data[0])
...
def data_miyazaki():
    raw_data = loadarff("../data_experiment/classic/miyazaki94.arff")
    df_data = pd.DataFrame(raw_data[0])
...
def data_cocomo81():
    raw_data = loadarff("../data_experiment/cocomo/cocomo81.arff")
    df_data = pd.DataFrame(raw_data[0])
...
def data_nasa93():
    raw_data = loadarff("../data_experiment/cocomo/nasa93.arff")
...
def data_cocomo_nasa_1():
    raw_data = loadarff("../data_experiment/cocomo/cocomonasa_v1.arff")
    df_data = pd.DataFrame(raw_data[0])
...
def data_cocomo(ind=0):
    if ind == 0:
        name = "cocomo81"
        return data_cocomo81(), name
    if ind == 1:
        name = "nasa93"
        return data_nasa93(), name
    if ind == 2:
        name = "cocomo10"
        return data_cocomo_nasa_1(), name


def data_classic(ind=0):
    if ind == 0:
        name = "kemerer"
        return data_kemerer(), name
    if ind == 1:
        name = "albrecht"
        return data_albrecht(), name
    if ind == 2:
        name = "isbsg10"
        return data_isbsg10(), name
    if ind == 3:
        name = "finnish"
        return data_finnish(), name
    if ind == 4:
        name = "miyazaki"
        return data_miyazaki(), name
    if ind == 5:
        name = "maxwell"
        return data_maxwell(), name
    if ind == 6:
        name = "desharnais"
        return data_desharnais(), name
    if ind == 7:
        name = "kitchenham"
        return data_kitchenham(), name
    if ind == 8:
        name = "china"
        return data_china(), name
